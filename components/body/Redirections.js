...
export default function Redirections() {
  return (
    <>
      <iframe
        src="https://docs.google.com/forms/d/e/1FAIpQLSdoqbEarbOjut8XsX339FlpAfD4u5GQe4z8ncRcW0Y4Qnytuw/viewform?embedded=true"
        width="100%"
        height="920"
        frameborder="0"
        marginheight="0"
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <span className="block text-blue-800">
              Puedes Dejar tu inquietud en este formulario.
            </span>
          </h2>
